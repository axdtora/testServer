...
const auth_midleware_1 = require("./common/auth.midleware");
let App = class App {
    ...
    useMiddelware() {
        ...
        const authMiddleware = new auth_midleware_1.AuthMiddleware(this.configService.get('SECRET'));
...
exports.App = App = __decorate([
    ...
    __param(1, (0, inversify_1.inject)(types_1.TYPES.UserCotroller)),
    __param(2, (0, inversify_1.inject)(types_1.TYPES.ExeptionFilter)),
    __param(3, (0, inversify_1.inject)(types_1.TYPES.ConfigServise)),
